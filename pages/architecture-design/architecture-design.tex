...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{inventive-steps.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{conversational-trees.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{vader-model.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{syntax-parsing.png}

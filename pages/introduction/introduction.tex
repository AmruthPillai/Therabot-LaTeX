...
\begin{figure}[H]
    \centering
    \includegraphics[width=6cm]{roots-mental-health-issues.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=8cm]{cbt-diagram.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=8cm]{chatbot-usecases.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{ai-overview.png}

...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{screenshots/jupyter-notebook/tokenizing.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{screenshots/jupyter-notebook/stemming.png}
...
\begin{tabular}{|c|c|}
    ...
    \hline
\end{tabular}
\captionof{table}{Gradient Descent - Test Results}\label{tbl:nicetablelesstable}
\end{center}
